...
class Post < ApplicationRecord
  ...
  def not_spam
    ...
    spammy_phrases = ["my web page", "my webpage", "look at my page", "free trial", "visit my blog", "blog post", "my homepage", "my web-site", "my page", "%anchor_text", "my web site", "to my site", "poker", "my website", "my weblog", "web blog"]
