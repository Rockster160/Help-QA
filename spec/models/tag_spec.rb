...
RSpec.describe Tag, type: :model do
  ...
  context "similar tags" do
    ...
    let!(:post1) { ::FactoryGirl.create(:post, body: "this this this", author: user) }
    let!(:post2) { ::FactoryGirl.create(:post, body: "this this this", author: user) }
    let!(:post3) { ::FactoryGirl.create(:post, body: "this this this", author: user) }
    let!(:post4) { ::FactoryGirl.create(:post, body: "this this this", author: user) }

    let!(:similar_tag1) { ::FactoryGirl.create(:tag, tag_name: "love") }
    let!(:similar_tag2) { ::FactoryGirl.create(:tag, tag_name: "hate") }
    ...
    it "should only return tags that have at least 3 posts in common" do
      expect(similar_tag1.similar_tags).to match_array([similar_tag2])
      expect(unsimilar_tag1.similar_tags).to match_array([])
    end
  end
